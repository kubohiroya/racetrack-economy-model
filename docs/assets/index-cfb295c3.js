...
`,Vl=(e,t)=>y`
    ...
    `.withBehaviors(U(y`
            ...
            `));class Ll extends at{sliderOrientationChanged(){this.sliderOrientation===H.horizontal?(this.$fastController.addStyles(xs),this.$fastController.removeStyles(ks)):(this.$fastController.addStyles(ks),this.$fastController.removeStyles(xs))}}const Il=Ll.compose({baseName:"slider-label",baseClass:at,template:xo,styles:Vl}),Nl=y`
    .track-start {
        left: 0;
    }
`,Al=y`
...
`,Pl=(e,t)=>y`
    ...
    `.withBehaviors(new xl(Nl,Al),U(y`
                .thumb-cursor {
                    forced-color-adjust: none;
                    border-color: ${u.FieldText};
                    background: ${u.FieldText};
            ...
            `)),El=j.compose({baseName:"slider",template:ko,styles:Pl,thumb:`
