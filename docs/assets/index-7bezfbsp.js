...
`,oc=Ot.compose({baseName:"radio-group",template:Yo,styles:rc}),ac=(i,t)=>R`
        ...
        :host(:${D}) .control {
            box-shadow: 0 0 0 2px ${Y}, 0 0 0 4px ${yt};
        }
...
`,cc=(i,t)=>R`
    ...
    `.withBehaviors(it(R`
            ...
            `));class hc extends Tt{sliderOrientationChanged(){this.sliderOrientation===Z.horizontal?(this.$fastController.addStyles(cn),this.$fastController.removeStyles(hn)):(this.$fastController.addStyles(hn),this.$fastController.removeStyles(cn))}}const dc=hc.compose({baseName:"slider-label",baseClass:Tt,template:Jo,styles:cc}),uc=R`
    .track-start {
        left: 0;
    }
`,fc=R`
